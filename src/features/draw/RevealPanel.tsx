...
export default function RevealPanel() {
  ...
  return (
    <div className="flex flex-col items-center py-8 min-h-[650px] w-full animate-fade-in">
          ...
          >
            {set.map((n, colIdx) =>
              n !== undefined ? (
                ...
                <span
                  key={colIdx}
                  className="flex items-center justify-center rounded-full bg-white text-gray-300 font-black border-[2px] border-gray-200 select-none aspect-square opacity-80"
                  style={{
                    width: "clamp(2.2rem, 7vw, 3rem)",
                    minWidth: 40,
                    height: "clamp(2.2rem, 7vw, 3rem)",
